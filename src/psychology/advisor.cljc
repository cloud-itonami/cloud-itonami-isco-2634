(ns psychology.advisor
  "PracticeAdvisor — proposes a psychology-practice operation (log a
  session, document a note, disclose a crisis risk, recommend an
  involuntary hold) for a registered client. The advisor is swappable:
  ...
  and has no notion of client provenance or crisis-risk/involuntary-
  hold consequences; `psychology.governor` is the independent system
  that decides whether the proposal may proceed, per the itonami
  actor pattern.

  A proposal is a map:
    {:op :session|:document|:disclose-crisis-risk|:recommend-involuntary-hold
...
(def ^:private system-prompt
  "You are a psychology-practice advisor. Given a practice operation
